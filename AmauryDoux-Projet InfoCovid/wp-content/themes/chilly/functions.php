...
if (!get_option('chilly_user_with_1_3_7', false)) {
    //detect old user and set value
    $chilly_service_title=get_theme_mod('home_service_section_title');
    $chilly_service_discription=get_theme_mod('home_service_section_discription');
    $chilly_blog_title=get_theme_mod('home_news_section_title');
    $chilly_blog_discription=get_theme_mod('home_news_section_discription');
    $chilly_slider_title=get_theme_mod('home_slider_title');
    $chilly_slider_discription=get_theme_mod('home_slider_discription'); 
    $chilly_testimonial_title=get_theme_mod('home_testimonial_section_title'); 
    $chilly_testimonial__discription=get_theme_mod('home_testimonial_section_discription');
    $chilly_footer_credit=get_theme_mod('footer_copyright_text');

    if ($chilly_service_title !=null || $chilly_service_discription !=null || $chilly_blog_title !=null || $chilly_blog_discription !=null || $chilly_slider_title !=null || $chilly_slider_discription !=null || $chilly_testimonial_title !=null || $chilly_testimonial__discription !=null || $chilly_footer_credit !=null )  {
        add_option('chilly_user_with_1_3_7', 'old');

    } else {
        add_option('chilly_user_with_1_3_7', 'new');
    }
}

//Remove Footer section
function chilly_remove_customize_register( $wp_customize ) {

   $wp_customize->remove_section( 'spicepress_footer_copyright');

}
add_action( 'customize_register', 'chilly_remove_customize_register',11);